...
class App extends BaseConfig
{
    ...
    public string $appTimezone = 'America/Argentina/Mendoza';
    ...
    // Agrega o modifica la configuración de las cabeceras de CORS
public $CORSHeaders = [
    'Access-Control-Allow-Origin'      => 'http://localhost',
    'Access-Control-Allow-Methods'     => 'GET, POST, OPTIONS, PUT, DELETE',
    'Access-Control-Allow-Headers'     => 'Content-Type, X-Requested-With',
    'Access-Control-Allow-Credentials' => 'true',
    'Access-Control-Max-Age'           => '86400', // Tiempo en segundos durante el cual prefiere cachear las opciones de solicitud
];
